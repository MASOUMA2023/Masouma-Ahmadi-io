...
//list the skills under skills section
const skillsList = [
  "JavaScript",
  "HTML",
  "CSS",
...
//create message form under message section
...
messageForm.addEventListener("submit", (e) => {
  ...
  //add messages list under the form
...
//create edit button for message section
...
//create remove button for message section
function makeRemoveButton() {
  ...
  button.addEventListener("click", () => {
    ...
    } else messagesSection.hidden = false;
  });
  return button;
}
...
fetch(`https://api.github.com/users/${userName}/repos`)
  ...
  .then((data) => {
    ...
    //list repos under projects section
